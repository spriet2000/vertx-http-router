...
public class RouterImpl implements Router {
    ...
    public Router get(String path, RouteHandler handler) {
        ...
        getTree.addNode(Utils.sanitizePath(path), handler);
        return this;
    }
    ...
    public Router head(String path, RouteHandler handler) {
        ...
        headTree.addNode(Utils.sanitizePath(path), handler);
        return this;
    }
    ...
    public Router post(String path, RouteHandler handler) {
        ...
        postTree.addNode(Utils.sanitizePath(path), handler);
        return this;
    }
    ...
    public Router put(String path, RouteHandler handler) {
        ...
        putTree.addNode(Utils.sanitizePath(path), handler);
        return this;
    }
    ...
    public Router patch(String path, RouteHandler handler) {
        ...
        patchTree.addNode(Utils.sanitizePath(path), handler);
        return this;
    }
    ...
    public Router delete(String path, RouteHandler handler) {
        ...
        deleteTree.addNode(Utils.sanitizePath(path), handler);
        return this;
    }
    ...
    public void handle(HttpServerRequest request) {
        Route route = route(request.method(), Utils.sanitizePath(request.path()));
        assert route != null;
